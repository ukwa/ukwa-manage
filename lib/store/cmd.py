...
def main():
    ...
    parser_cv = subparsers.add_parser('lsr-to-sqlite', help='Read a hadoop fs -lsr format file listing and convert to SQLite')
    parser_cv.add_argument('input_lsr', type=str, help='The file to read, in hadoop fs -lsr format. Can be "-" for STDIN.')
    parser_cv.add_argument('output_sqlite', type=str, help='The file to output to in SQLite format.')
